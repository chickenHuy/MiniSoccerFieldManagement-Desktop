...
public class ThemesChange extends JPanel{
    ...
    private void init() {
        ...
        panel.putClientProperty(FlatClientProperties.STYLE, ""
                + "arc:999;"
                + "background:darken($TitlePane.background,5%)");
        JButton buttonLight = new JButton(createIcon("minisoccerfieldmanagement/drawer/icon/light.svg"));
        JButton buttonDark = new JButton(createIcon("minisoccerfieldmanagement/drawer/icon/dark.svg"));
        ...
        buttonLight.putClientProperty(FlatClientProperties.STYLE, ""
                ...
                + "[light]background:$TitlePane.background;"
                + "borderWidth:0;"
                + "focusWidth:0;"
                + "innerFocusWidth:0;"
                + "margin:3,5,3,5");
        ...
        buttonDark.putClientProperty(FlatClientProperties.STYLE, ""
                + "arc:999;"
                + "[dark]background:$TitlePane.background;"
